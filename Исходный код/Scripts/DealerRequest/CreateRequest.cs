...
namespace OBO_Tools.Scripts
{
    class CreateRequest
    {
        ...
        public static void changeFont()
        {
            ...
            {
                mainWindow.fxRequestArea.Find(listOfSTRForChangeFont[i]);
                if (i < listOfSTRForChangeFont.Count - 2)
                    mainWindow.fxRequestArea.SelectionFont = boldFont;
                else if (mainWindow.needAnswerCheckbox.Checked)
                {
                    mainWindow.fxRequestArea.SelectionColor = Color.Red;
                    mainWindow.fxRequestArea.SelectionFont = boldFont;
                }
            }
        }
