...
namespace OBO_Tools.Objects
{
    class UserObject
    {
        ...
        public List<TranslitObject> listOfChar; //Лист русских и английских Char для перевода текста в транзлит
        ...
        public List<RowOfTicketObject> checkList; //Чек-лист после прочтения CSV
